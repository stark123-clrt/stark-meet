    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-surface rounded-lg shadow-2xl w-full max-w-md border border-slate-200">
        <div className="flex items-center justify-between p-4 border-b border-slate-200">
          ...
          <button onClick={onClose} className="p-1.5 rounded-md text-slate-500 hover:text-slate-950 hover:bg-slate-100 transition-colors">
            <X className="h-5 w-5" />
          </button>
        </div>
            ...
            <>
              <div className="space-y-2.5">
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 bg-surface border border-slate-200 rounded-md text-slate-950 text-sm focus:outline-none focus:border-brand-500 transition-colors"
                >
              ...
              <div className="flex items-start gap-3 p-3.5 bg-slate-100 border border-slate-200 rounded-md">
                <Monitor className="h-4 w-4 text-slate-700 flex-shrink-0 mt-0.5" />
        ...
        <div className="flex items-center justify-end gap-3 p-4 border-t border-slate-200">
          <button onClick={onClose} className="px-4 py-2 rounded-md text-sm text-slate-500 hover:text-slate-950 hover:bg-slate-100 transition-colors">
            Annuler
          </button>
          <button
            onClick={applyDeviceChanges}
            disabled={isLoading || !selectedVideoId || !selectedAudioId}
            className="px-4 py-2 rounded-md bg-brand-500 hover:bg-brand-600 text-slate-950 text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Appliquer
          </button>
        </div>
